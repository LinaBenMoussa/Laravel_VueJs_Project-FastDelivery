   ...
   <div class="container-fluid">
     ...
     <div class="collapse navbar-collapse" id="navbarColor01">
       <ul class="navbar-nav me-auto">
         <li class="nav-item">
             <router-link class="nav-link active"  to="/restaurants">Restaurants
            
         </router-link>
           </li>
           <li class="nav-item">
             <router-link class="nav-link active"  to="/tables">tables
            
         </router-link>
           </li>
         <li class="nav-item">
           <router-link class="nav-link active"  to="/menus">Menus
             </router-link>
         </li>
         <li class="nav-item">
           <router-link class="nav-link active"  to="/foodsclient">Foods Client
             </router-link>
         </li>
         <li class="nav-item">
           <router-link class="nav-link active"  to="/foods">Foods
             </router-link>
         </li>
         <li class="nav-item">
         ...
         <li class="nav-item">
           <router-link class="nav-link active"  to="/menusclient">Menus Client
             </router-link>
         </li>
         <li class="nav-item">
           <router-link class="nav-link active"  to="/restaurantsclient">Restaurants Client
             </router-link>
         </li>
         <li class="nav-item">
